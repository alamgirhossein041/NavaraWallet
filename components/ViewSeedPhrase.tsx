...
export default function ViewSeedPhrase(props) {
  ...
  return (
    <ScrollView style={tw`px-4 mb-15`} showsVerticalScrollIndicator={false}>
      <Text style={tw`my-1 android:mt-5 ios:mt-10 text-2xl font-bold text-center`}>
        Your seed phrase
      </Text>
      <Text style={tw`mx-5 my-1 text-center text-gray-500`}>
            ...
            seedPhrase?.map((item, index) => {
              return (
                <View
                  ...
                  <View
                    style={tw`flex items-center justify-center w-5 h-5 mr-auto bg-white rounded-full `}>
                    <Text style={tw`font-bold`}>{index + 1}</Text>
                  </View>
                  <Text style={tw`mr-auto font-semibold`}>{item}</Text>
                </View>
              );
            })}
        </View>
      ...
      <View style={tw`mx-auto items-center bg-gray-100 p-3 my-3 rounded-lg`}>
      ...
      <View style={tw`mx-auto items-center bg-gray-100 p-3 mb-10 rounded-lg`}>
        <View style={tw`flex flex-row`}>
        ...
        <Text style={tw`py-2 text-justify`}>
