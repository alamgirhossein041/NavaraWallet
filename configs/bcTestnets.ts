...
export const EVM_TESTNET_CONFIG = {
  [NETWORKS.ETHEREUM]: {
    ...
    rpc: "https://goerli.infura.io/v3/a383cc1a30ed4d64ab93408862cdf8d7",
    chainId: 5,
  },
  [NETWORKS.POLYGON]: {
    name: "MUMBAI",
...
export const ALCHEMY_TESTNET_NETWORK = {
  [NETWORKS.ETHEREUM]: "eth-goerli",
  [NETWORKS.OPTIMISM]: "opt-goerli",
  [NETWORKS.ARBITRUM]: "arb-rinkeby",
  [NETWORKS.POLYGON]: "polygon-mumbai",
};
