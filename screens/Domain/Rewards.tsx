    ...
    <ScrollView style={tw`bg-white dark:bg-[#18191A]  `}>
      ...
      >
        ...
        <TouchableOpacity style={tw`px-5 ml-auto`}>
          <Text style={tw`dark:text-white  text-[#2FA2B9]`}>Share</Text>
        </TouchableOpacity>
      </View>
      <Text style={tw`dark:text-white  text-center text-[12px] my-5`}>
      ...
      >
        ...
        <TouchableOpacity style={tw`ml-auto px-5`}>
          <Text style={tw`dark:text-white  `}>15 Npoint</Text>
        </TouchableOpacity>
      </View>
      <Text style={tw`dark:text-white   mx-5 text-[12px] my-5`}>
        Who invites you?
      </Text>
      <View style={tw`mx-5`}>
        <TextField
